...
UPDATE Clientes SET endereco = 'Av. Z, 999' WHERE cliente_id = 1;

UPDATE Produtos SET preco = 79.99 WHERE produto_id = 9;

UPDATE Produtos SET quantidade_estoque = 30 WHERE produto_id = 6;

UPDATE Pedidos SET data_estimada_entrega = '2024-04-05' WHERE pedido_id = 3;
